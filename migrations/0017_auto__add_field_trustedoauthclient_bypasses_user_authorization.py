...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('spotseeker_server_trustedoauthclient', 'bypasses_user_authorization',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('spotseeker_server_trustedoauthclient', 'bypasses_user_authorization')
