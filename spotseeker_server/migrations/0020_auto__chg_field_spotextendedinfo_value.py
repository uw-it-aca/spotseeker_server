...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('spotseeker_server_spotextendedinfo', 'value', self.gf('django.db.models.fields.CharField')(max_length=350))

    def backwards(self, orm):

        # Changing field 'SpotExtendedInfo.value'
        db.alter_column('spotseeker_server_spotextendedinfo', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))
