...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Item.category' to match new field type.
        db.rename_column('spotseeker_server_item', 'category_id', 'category')
        ...
        db.rename_column('spotseeker_server_item', 'subcategory_id', 'subcategory')
    ...
    def backwards(self, orm):
        # Adding index on 'Item', fields ['subcategory']
        db.create_index('spotseeker_server_item', ['subcategory_id'])

        # Adding index on 'Item', fields ['category']
        db.create_index('spotseeker_server_item', ['category_id'])
        ...
        # Renaming column for 'Item.category' to match new field type.
        db.rename_column('spotseeker_server_item', 'category', 'category_id')
        # Changing field 'Item.category'
        db.alter_column('spotseeker_server_item', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spotseeker_server.ItemCategory'], null=True))

        # Renaming column for 'Item.subcategory' to match new field type.
        db.rename_column('spotseeker_server_item', 'subcategory', 'subcategory_id')
        # Changing field 'Item.subcategory'
        db.alter_column('spotseeker_server_item', 'subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spotseeker_server.ItemSubcategory'], null=True))
