...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemImage.modification_date'
        db.add_column('spotseeker_server_itemimage', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2016, 10, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ItemImage.etag'
        db.add_column('spotseeker_server_itemimage', 'etag',
                      self.gf('django.db.models.fields.CharField')(default='78362a4163654c6f05b7988644167ba11c6cf80e', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemImage.modification_date'
        db.delete_column('spotseeker_server_itemimage', 'modification_date')

        # Deleting field 'ItemImage.etag'
        db.delete_column('spotseeker_server_itemimage', 'etag')
