...
class SpotSearchDistanceTest(TestCase):
    ...
    def test_invalid_latitude(self):
        ...
        self.assertEquals(response.status_code, 200,
                          "Accepts a query with bad latitude")
    ...
    def test_invalid_longitude(self):
        ...
        self.assertEquals(response.status_code, 200,
                          "Accepts a query with bad longitude")
        self.assertEquals(response["Content-Type"],
                          "application/json",
                          "Has the json header")
        self.assertEquals(response.content, '[]',
    ...
    def test_invalid_height(self):
        ...
        self.assertEquals(response.status_code, 200,
                          "Accepts a query with bad height")
        self.assertEquals(response["Content-Type"],
                          "application/json",
                          "Has the json header")
        self.assertEquals(response.content, '[]',
    ...
    def test_invalid_distance(self):
        ...
        self.assertEquals(response.status_code, 200,
                          "Accepts a query with bad distance")
        self.assertEquals(response["Content-Type"],
                          "application/json",
                          "Has the json header")
        self.assertEquals(response.content, '[]',
    ...
    def test_no_params(self):
        ...
        self.assertEquals(response.status_code, 200,
                          "Accepts a query with no params")
        self.assertEquals(response["Content-Type"],
                          "application/json",
                          "Has the json header")
        self.assertEquals(response.content, '[]',
    ...
    def test_distances(self):
        ...
        self.assertEquals(response.status_code, 200,
                          "Accepts a query with no matches")
        self.assertEquals(response["Content-Type"],
                          "application/json",
                          "Has the json header")
        self.assertEquals(response.content, '[]',
        ...
        for spot in spots:
            self.assertEquals(spot_ids[spot['id']],
                              1,
                              "Spot matches a unique inner spot")
            spot_ids[spot['id']] = 2
        ...
        self.assertEquals(spot_ids[inner_left.pk], 2,
                          "Inner left was selected")
        self.assertEquals(spot_ids[inner_right.pk], 2,
                          "Inner right was selected")
        self.assertEquals(spot_ids[inner_top.pk], 2,
                          "Inner top was selected")
        self.assertEquals(spot_ids[inner_bottom.pk], 2,
                          "Inner bottom was selected")
        ...
        self.assertEquals(spot_ids[mid_left.pk], 2,
                          "Mid left was selected")
        self.assertEquals(spot_ids[mid_right.pk], 2,
                          "Mid rightwas selected")
        self.assertEquals(spot_ids[mid_top.pk], 2,
                          "Mid top was selected")
        self.assertEquals(spot_ids[mid_bottom.pk], 2,
                          "Mid bottom was selected")
        ...
        self.assertEquals(response["Content-Type"],
                          ...
                          "Has the json header")
        spots = json.loads(response.content)
        self.assertEquals(len(spots), 12,
                          "Returns 12 spots with a limit of 0")
        spot_ids = {
            inner_left.pk: 1,
            inner_right.pk: 1,
            inner_top.pk: 1,
        ...
        self.assertEquals(response["Content-Type"],
                          ...
                          "Has the json header")
        spots = json.loads(response.content)
        self.assertEquals(len(spots), 20,
                          "Returns 20 spots with no defined limit")
        spot_ids = {
            inner_left.pk: 1,
            inner_right.pk: 1,
            inner_top.pk: 1,
        ...
        self.assertEquals(response["Content-Type"],
                          ...
                          "Has the json header")
        spots = json.loads(response.content)
        self.assertEquals(len(spots), 112,
                          "Returns 112 spots with a limit of 0")
        spot_ids = {
            inner_left.pk: 1,
            inner_right.pk: 1,
            inner_top.pk: 1,
        ...
        self.assertEquals(far_out_count, 100,
                          "Found all 100 far out spots")
