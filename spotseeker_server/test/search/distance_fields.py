...
class SpotSearchDistanceFieldTest(TestCase):
    ...
    def test_distances(self):
        ...
        with self.settings(
            ...
            inner_top = Spot.objects.create(name="Atlantic Location 1",
                                            latitude=Decimal('31.0000898315'),
                                            longitude=Decimal('-41.0'))
            inner_top.save()

            inner_top2 = Spot.objects.create(name="Alternate name of AL1",
                                             latitude=Decimal('31.0000898315'),
                                             longitude=Decimal('-41.0'))
            inner_top2.save()

            mid_top = Spot.objects.create(name="Atlantic Location 2",
