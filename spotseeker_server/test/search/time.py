...
class SpotSearchTimeTest(TestCase):
    def test_SameDayTimeInSerial(self):
        ...
        spot2 = new_spot("This is a second spot to test time ranges in search")
        ...
        response = c.get(
            "/api/v1/spot/",
            {"open_at": "Friday,11:00", "open_until": "Friday,14:00"},
        ...
        response = c.get(
            "/api/v1/spot/",
            {"open_at": "Thursday,11:00", "open_until": "Thursday,15:00"},
            content_type="application/json",
        )
    ...
    def test_DiffDayTimeInSerial(self):
        ...
        spot3 = new_spot(
            "This is a third spot to test time " "ranges in search"
        )
        ...
        response = c.get(
            "/api/v1/spot/",
            {"open_at": "Monday,10:00", "open_until": "Friday,10:00"},
            content_type="application/json",
        )
    ...
    def test_SameDayTimeInReverse(self):
        ...
        response = c.get(
            "/api/v1/spot/",
            {"open_at": "Monday,15:00", "open_until": "Monday,10:00"},
            content_type="application/json",
        )
    ...
    def test_FullWeek(self):
        ...
        response = c.get(
            "/api/v1/spot/",
            {"open_at": "Thursday,11:00", "open_until": "Wednesday,20:00"},
            content_type="application/json",
        )
